...
if (diceQ == 1)
printf("     That's a brilliant move!\n");
if (diceQ == 2)
...
printf("     You displayed great technique!\n");
...
if (((cpusp < 2) && (ctr < 10) && (new6 > 0)) || ((cpusp < 2) && (ctr < 10) && (new6 < 1)) || ((cpusp < 2) && (ctr > 9) && (new6 > 0)))
printf("\n");
...
if (((ctr < 10) && (cpusp > 1) && (new6 < 1)) || ((ctr > 9) && (cpusp < 2) && (new6 < 1)) || ((ctr > 9) && (cpusp > 1) && (new6 > 0)))
printf("\n");
if (new6 > 0)
