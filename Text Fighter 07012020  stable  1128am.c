...
if (diceQ == 3)
printf("     A completely awesome combo!\n");
}
...
{
diceQ = (rand() % 44) + 1;//12 24 32 38 40
if ((diceQ < 13) && (diceQ != 5) && (diceQ != 12))
printf("\n");
if (diceQ == 1)
...
diceQ1 = (rand() % 48) + 1;//14 16 32 38 42 44
if (((diceQ > 12) && (diceQ1 < 13) && (diceQ1 > 1)) || ((diceQ1 > 1) && (diceQ1 < 13) && (diceQ == 5) && (ctr < 9)) || ((diceQ1 > 1) && (diceQ1 < 13) && (diceQ == 12) && (ctr < 5)))
printf("\n");
if ((diceQ > 12) && (diceQ1 == 1) && (diceE <= 20) && (diceF <= 29) && (diceC <= 47) && (diceM <= 40))
printf("\n");
...
if (diceQ1 == 11)
printf("     Improve your defensive moves!\n\n");
if (diceQ1 == 12)
