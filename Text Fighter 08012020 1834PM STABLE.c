...
int spatt = 0, supspatt = 0, hypsp = 0, enspcomb1 = 0, enspcomb2 = 0, enspcomb3 = 0, enemspcombC = 0, c = 0, d = 0, e = 0, f = 0, g = 0, cpmag = 0, cpmag2 = 0, windup;
...
{
if (diceQ == 1)
printf("     It was an amazing follow-up!\n");
if (diceQ == 2)
...
printf("\n     Great magic powers!\n\n");
if ((new6 < 1) && (ctr > 5) && (cpusp > 1))
printf("\n     You displayed great ability!\n\n");
if ((new6 > 0) && (ctr > 5) && (cpusp < 2))
printf("\n     You demonstrated fantastic technique!\n\n");
...
if (diceQ == 3)
printf("     An incredibly awesome combo!\n");
}
...
printf("\n     That was completely outstanding!\n\n");
if ((cpusp > 1) && (ctr > 7) && (new6 > 0))
printf("\n     This was a fantastic Fight Text!\n\n");
if ((cpusp > 1) && (ctr < 8) && (new6 > 0))
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     You beat the opponent easily!\n");
if (diceQ == 2)
...
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     You used a brilliant strategy!\n");
if (diceQ == 2)
printf("     Absolutely phenomenal strategy!\n");
if (diceQ == 3)
printf("     You employed amazing tactics!\n");
}
if (ctr < 6)
{
diceQ = (rand() % 3) + 1;
...
if (((new6 < 1) && (ctr > 6) && (cpusp < 2)) || ((new6 > 0) && (cpusp < 2) && (ctr < 7)))
printf("\n");
if (ctr < 6)
{
diceQ = (rand() % 3) + 1;
...
if (diceS <= 6)//5
{
diceB = (rand() % 7) + 1;///8? MAYBE NOT
}
if (diceS >= 7)//6
{
diceB = (rand() % 9) + 1;///MAYBE 8
}
}
diceZ = (rand() % 10) + 1;//7
...
{
printf("\n     THE CPU SUPER HYPER MAGIC COMBO!\n");////
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
...
emagsup6 = 1;
diceZB = (rand() % 10) + 1;
if ((diceB >= 2) && (diceB <= 6) && (c < 1) && (d < 1) && (e < 1) && (f < 1) && (g < 1) && (playerhp > 0) && (diceZB > 5)) ///&& (c < 1)
{
...
if ((diceB >= 2) && (diceB <= 6) && (d < 1) && (e < 1) && (f < 1) && (g < 1) && (playerhp > 0) && (diceZB < 6)) // &&// (spatt > 0))/// taken out c
{
if (c < 1)
{
...
printf("\n     CPU executes Magic Bonus Attack!\n");
printf("     Player HP at %d\n\n", playerhp);
diceZC = (rand() % 10) + 1;//8
if (diceZC > 7)//5//6
{
...
{
diceQ = (rand() % 58) + 1;//12 24 32 38 40
...
diceQ1 = (rand() % 70) + 1;//14 16 32 38 42 44 48
if (((diceQ > 15) && (diceQ1 < 18) && (diceQ1 != 15) && (diceQ1 > 1)) || ((diceQ1 > 1) && (diceQ1 < 18) && (diceQ1 != 15) && ((diceQ == 5) || (diceQ == 13))  && (ctr < 9)) || ((diceQ1 > 1) && (diceQ1 < 18) && (diceQ1 != 15) && (diceQ == 12) && (ctr < 5)))
printf("\n");
if ((diceQ > 15) && (diceQ1 == 1) && (diceE <= 20) && (diceF <= 29) && (diceC <= 47) && (diceM <= 40))
printf("\n");
if ((diceQ > 15) && (diceQ1 == 15) && (windup > 0))
printf("\n");
...
if (diceQ1 == 9)
printf("     Work on your counter skills!\n\n");
if (diceQ1 == 10)
printf("     Work on your attack methods!\n\n");
if (diceQ1 == 11)
printf("     Practise your evasive moves!\n\n");
