...
{
printf("\n     THE CPU SPECIAL SUPER MAGIC COMBO!\n");
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     A GREAT SPECIAL SUPER MAGIC COMBO!\n");
if (diceQ == 2)
printf("     A NICE SPECIAL SUPER MAGIC COMBO!\n");
if (diceQ == 3)
printf("     A MEAN SPECIAL SUPER MAGIC COMBO!\n");
emgspcom5 = 0;
if (playerhp < 1)
{
diceQ = (rand() % 3) + 1;
if (diceQ == 1)
printf("     IT WAS A FANTASTIC CPU FINISH!\n\n");
if (diceQ == 2)
printf("     AND A STUNNING CPU MAGIC WIN!\n\n");
if (diceQ == 3)
...
{
diceQ = (rand() % 62) + 1;//12 24 32 38 40
